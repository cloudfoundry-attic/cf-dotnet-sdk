...
this.auth = client.auth;
  ...
  /// </summary>
    public async Task<ListAllServiceBrokersResponse[]> ListAllServiceBrokers()
    {
        string route = "/v2/service_brokers";
    ...
    var response = await client.SendAsync();
            ...
            return Util.DeserializeJsonArray<ListAllServiceBrokersResponse>(await response.ReadContentAsStringAsync());
