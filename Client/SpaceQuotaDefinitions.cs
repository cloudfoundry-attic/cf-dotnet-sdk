...
this.auth = client.auth;
  ...
  /// </summary>
    public async Task<ListAllSpacesForSpaceQuotaDefinitionResponse[]> ListAllSpacesForSpaceQuotaDefinition(Guid guid)
    {
    ...
    var response = await client.SendAsync();
            ...
            return Util.DeserializeJsonArray<ListAllSpacesForSpaceQuotaDefinitionResponse>(await response.ReadContentAsStringAsync());
  ...
  /// </summary>
    public async Task<ListAllSpaceQuotaDefinitionsResponse[]> ListAllSpaceQuotaDefinitions()
    {
        string route = "/v2/space_quota_definitions";
    ...
    var response = await client.SendAsync();
            ...
            return Util.DeserializeJsonArray<ListAllSpaceQuotaDefinitionsResponse>(await response.ReadContentAsStringAsync());
