...
this.auth = client.auth;
  ...
  /// </summary>
    public async Task<ListAllServicePlanVisibilitiesResponse[]> ListAllServicePlanVisibilities()
    {
        string route = "/v2/service_plan_visibilities";
    ...
    var response = await client.SendAsync();
            ...
            return Util.DeserializeJsonArray<ListAllServicePlanVisibilitiesResponse>(await response.ReadContentAsStringAsync());
