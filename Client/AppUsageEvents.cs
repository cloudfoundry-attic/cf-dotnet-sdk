...
this.auth = client.auth;
  ...
  /// </summary>
    ...
    public async Task<ListAllAppUsageEventsResponse[]> ListAllAppUsageEvents()
    {
    ...
    var response = await client.SendAsync();
            ...
            return Util.DeserializeJsonArray<ListAllAppUsageEventsResponse>(await response.ReadContentAsStringAsync());
