...
this.auth = client.auth;
  ...
  /// </summary>
    public async Task<ListAllAppsForRouteResponse[]> ListAllAppsForRoute(Guid guid)
    {
    ...
    var response = await client.SendAsync();
            ...
            return Util.DeserializeJsonArray<ListAllAppsForRouteResponse>(await response.ReadContentAsStringAsync());
  ...
  /// List all Routes
  /// </summary>
    public async Task<ListAllRoutesResponse[]> ListAllRoutes()
    {
        string route = "/v2/routes";
    ...
    var response = await client.SendAsync();
            ...
            return Util.DeserializeJsonArray<ListAllRoutesResponse>(await response.ReadContentAsStringAsync());
