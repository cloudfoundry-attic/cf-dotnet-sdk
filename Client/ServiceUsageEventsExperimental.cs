...
this.auth = client.auth;
  ...
  /// </summary>
    ...
    public async Task<ListServiceUsageEventsResponse[]> ListServiceUsageEvents()
    {
    ...
    var response = await client.SendAsync();
            ...
            return Util.DeserializeJsonArray<ListServiceUsageEventsResponse>(await response.ReadContentAsStringAsync());
