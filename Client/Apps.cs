...
this.auth = client.auth;
  ...
  /// List all Apps
  /// </summary>
    public async Task<ListAllAppsResponse[]> ListAllApps()
    {
        string route = "/v2/apps";
    ...
    var response = await client.SendAsync();
            ...
            return Util.DeserializeJsonArray<ListAllAppsResponse>(await response.ReadContentAsStringAsync());
  ...
  /// </summary>
    public async Task<ListAllRoutesForAppResponse[]> ListAllRoutesForApp(Guid guid)
    {
    ...
    var response = await client.SendAsync();
            ...
            return Util.DeserializeJsonArray<ListAllRoutesForAppResponse>(await response.ReadContentAsStringAsync());
  ...
  /// </summary>
    public async Task<ListAllServiceBindingsForAppResponse[]> ListAllServiceBindingsForApp(Guid guid)
    {
    ...
    var response = await client.SendAsync();
            ...
            return Util.DeserializeJsonArray<ListAllServiceBindingsForAppResponse>(await response.ReadContentAsStringAsync());
