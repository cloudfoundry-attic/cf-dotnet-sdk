...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class AssociateOrganizationWithUserResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AssociateOrganizationWithUserResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AssociateOrganizationWithUserResponse : IResponse
    {
