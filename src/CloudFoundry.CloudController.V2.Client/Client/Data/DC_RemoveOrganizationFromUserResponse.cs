...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class RemoveOrganizationFromUserResponse : CloudFoundry.CloudController.V2.Client.Data.Base.RemoveOrganizationFromUserResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class RemoveOrganizationFromUserResponse : IResponse
    {
