...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class RetrieveOrganizationResponse : CloudFoundry.CloudController.V2.Client.Data.Base.RetrieveOrganizationResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class RetrieveOrganizationResponse : IResponse
    {
