...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListAllAuditedOrganizationsForUserResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListAllAuditedOrganizationsForUserResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListAllAuditedOrganizationsForUserResponse : IResponse
    {
