...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class GetAppSummaryResponse : CloudFoundry.CloudController.V2.Client.Data.Base.GetAppSummaryResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class GetAppSummaryResponse : IResponse
    {
