...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListAllPrivateDomainsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListAllPrivateDomainsResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListAllPrivateDomainsResponse : IResponse
    {
