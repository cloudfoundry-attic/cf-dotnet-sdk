...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class RetrieveServiceBindingResponse : CloudFoundry.CloudController.V2.Client.Data.Base.RetrieveServiceBindingResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class RetrieveServiceBindingResponse : IResponse
    {
