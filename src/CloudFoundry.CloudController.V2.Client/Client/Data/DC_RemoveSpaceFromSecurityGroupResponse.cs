...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class RemoveSpaceFromSecurityGroupResponse : CloudFoundry.CloudController.V2.Client.Data.Base.RemoveSpaceFromSecurityGroupResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class RemoveSpaceFromSecurityGroupResponse : IResponse
    {
