...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListAllUserProvidedServiceInstancesResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListAllUserProvidedServiceInstancesResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListAllUserProvidedServiceInstancesResponse : IResponse
    {
