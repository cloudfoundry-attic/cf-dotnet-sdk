...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class CreateSecurityGroupResponse : CloudFoundry.CloudController.V2.Client.Data.Base.CreateSecurityGroupResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class CreateSecurityGroupResponse : IResponse
    {
