...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListAppDeleteEventsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListAppDeleteEventsResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListAppDeleteEventsResponse : IResponse
    {
