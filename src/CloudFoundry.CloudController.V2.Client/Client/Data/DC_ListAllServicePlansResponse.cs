...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListAllServicePlansResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListAllServicePlansResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListAllServicePlansResponse : IResponse
    {
