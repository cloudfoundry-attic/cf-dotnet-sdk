...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class AssociateAuditedSpaceWithUserResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AssociateAuditedSpaceWithUserResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AssociateAuditedSpaceWithUserResponse : IResponse
    {
