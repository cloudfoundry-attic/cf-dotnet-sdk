...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListAllSecurityGroupsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListAllSecurityGroupsResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListAllSecurityGroupsResponse : IResponse
    {
