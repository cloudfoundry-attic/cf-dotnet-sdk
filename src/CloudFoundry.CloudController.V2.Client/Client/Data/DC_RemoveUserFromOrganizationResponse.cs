...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class RemoveUserFromOrganizationResponse : CloudFoundry.CloudController.V2.Client.Data.Base.RemoveUserFromOrganizationResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class RemoveUserFromOrganizationResponse : IResponse
    {
