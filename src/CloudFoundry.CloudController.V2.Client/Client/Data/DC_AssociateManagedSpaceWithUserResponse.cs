...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class AssociateManagedSpaceWithUserResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AssociateManagedSpaceWithUserResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AssociateManagedSpaceWithUserResponse : IResponse
    {
