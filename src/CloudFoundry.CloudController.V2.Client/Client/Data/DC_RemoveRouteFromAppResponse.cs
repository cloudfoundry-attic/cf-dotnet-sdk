...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class RemoveRouteFromAppResponse : CloudFoundry.CloudController.V2.Client.Data.Base.RemoveRouteFromAppResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class RemoveRouteFromAppResponse : IResponse
    {
