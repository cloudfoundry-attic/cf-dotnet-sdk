...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class AssociateAuditorWithSpaceResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AssociateAuditorWithSpaceResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AssociateAuditorWithSpaceResponse : IResponse
    {
