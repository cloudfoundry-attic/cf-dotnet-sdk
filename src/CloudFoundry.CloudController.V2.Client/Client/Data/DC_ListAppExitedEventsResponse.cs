...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListAppExitedEventsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListAppExitedEventsResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListAppExitedEventsResponse : IResponse
    {
