...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListSpaceCreateEventsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListSpaceCreateEventsResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListSpaceCreateEventsResponse : IResponse
    {
