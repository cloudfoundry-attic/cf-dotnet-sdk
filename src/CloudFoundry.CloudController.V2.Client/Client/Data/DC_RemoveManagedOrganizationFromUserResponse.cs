...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class RemoveManagedOrganizationFromUserResponse : CloudFoundry.CloudController.V2.Client.Data.Base.RemoveManagedOrganizationFromUserResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class RemoveManagedOrganizationFromUserResponse : IResponse
    {
