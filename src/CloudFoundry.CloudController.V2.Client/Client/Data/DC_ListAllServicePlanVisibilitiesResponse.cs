...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListAllServicePlanVisibilitiesResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListAllServicePlanVisibilitiesResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListAllServicePlanVisibilitiesResponse : IResponse
    {
