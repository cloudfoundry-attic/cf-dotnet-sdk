...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListAppUpdateEventsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListAppUpdateEventsResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListAppUpdateEventsResponse : IResponse
    {
