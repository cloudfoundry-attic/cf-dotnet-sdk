...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListAllManagedOrganizationsForUserResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListAllManagedOrganizationsForUserResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListAllManagedOrganizationsForUserResponse : IResponse
    {
