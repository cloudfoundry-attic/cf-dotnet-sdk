...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class SetSecurityGroupAsDefaultForStagingResponse : CloudFoundry.CloudController.V2.Client.Data.Base.SetSecurityGroupAsDefaultForStagingResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class SetSecurityGroupAsDefaultForStagingResponse : IResponse
    {
