...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class UpdateAppResponse : CloudFoundry.CloudController.V2.Client.Data.Base.UpdateAppResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class UpdateAppResponse : IResponse
    {
