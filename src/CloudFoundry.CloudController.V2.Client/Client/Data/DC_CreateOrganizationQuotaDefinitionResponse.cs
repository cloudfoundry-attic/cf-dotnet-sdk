...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class CreateOrganizationQuotaDefinitionResponse : CloudFoundry.CloudController.V2.Client.Data.Base.CreateOrganizationQuotaDefinitionResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class CreateOrganizationQuotaDefinitionResponse : IResponse
    {
