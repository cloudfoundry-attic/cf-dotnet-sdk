...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListAllSpaceQuotaDefinitionsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListAllSpaceQuotaDefinitionsResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListAllSpaceQuotaDefinitionsResponse : IResponse
    {
