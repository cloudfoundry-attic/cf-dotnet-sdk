...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class RetrieveSpaceQuotaDefinitionResponse : CloudFoundry.CloudController.V2.Client.Data.Base.RetrieveSpaceQuotaDefinitionResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class RetrieveSpaceQuotaDefinitionResponse : IResponse
    {
