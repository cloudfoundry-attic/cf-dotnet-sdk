...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListAllRoutesForAppResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListAllRoutesForAppResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListAllRoutesForAppResponse : IResponse
    {
