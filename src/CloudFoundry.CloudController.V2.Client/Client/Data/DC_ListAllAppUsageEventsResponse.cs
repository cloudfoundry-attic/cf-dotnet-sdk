...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListAllAppUsageEventsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListAllAppUsageEventsResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListAllAppUsageEventsResponse : IResponse
    {
