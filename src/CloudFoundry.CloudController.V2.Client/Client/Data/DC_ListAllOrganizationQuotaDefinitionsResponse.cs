...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListAllOrganizationQuotaDefinitionsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListAllOrganizationQuotaDefinitionsResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListAllOrganizationQuotaDefinitionsResponse : IResponse
    {
