...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class RemoveAuditedOrganizationFromUserResponse : CloudFoundry.CloudController.V2.Client.Data.Base.RemoveAuditedOrganizationFromUserResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class RemoveAuditedOrganizationFromUserResponse : IResponse
    {
