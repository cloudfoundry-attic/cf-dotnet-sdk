...
namespace CloudFoundry.CloudController.V2.Client.Data
{
    ...
    public partial class ListSpaceUpdateEventsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.ListSpaceUpdateEventsResponse
    {
    }
}
...
{
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class ListSpaceUpdateEventsResponse : IResponse
    {
