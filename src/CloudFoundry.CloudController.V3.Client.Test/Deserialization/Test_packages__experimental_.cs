      ...
      ""links"": {
        ...
        ""app"": {
          ""href"": ""/v3/apps/79ad15e1-bf92-41fd-b4dc-e52ab03c1628""
            ...
            Assert.AreEqual("98028801-441f-41ef-9495-4898262cc237", TestUtil.ToTestableString(page[0].Guid), true);
            ...
            Assert.AreEqual("2016-03-30T10:15:14Z", TestUtil.ToTestableString(page[0].CreatedAt), true);
      ...
      ""links"": {
        ...
        ""app"": {
          ""href"": ""/v3/apps/e13827a2-d1d5-4d7b-ba4a-57b587ca8fb4""
            ...
            Assert.AreEqual("517e37a3-28f9-4610-b9d6-e3d9b68b2b2c", TestUtil.ToTestableString(page[0].Guid), true);
            Assert.AreEqual("bits", TestUtil.ToTestableString(page[0].Type), true);
            Assert.AreEqual("AWAITING_UPLOAD", TestUtil.ToTestableString(page[0].State), true);
            Assert.AreEqual("2016-03-30T10:15:14Z", TestUtil.ToTestableString(page[0].CreatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].UpdatedAt), true);
            Assert.AreEqual("517e37a3-28f9-4610-b9d6-e3d9b68b2b2c", TestUtil.ToTestableString(page[1].Guid), true);
            ...
            Assert.AreEqual("2016-03-30T10:15:14Z", TestUtil.ToTestableString(page[1].CreatedAt), true);
