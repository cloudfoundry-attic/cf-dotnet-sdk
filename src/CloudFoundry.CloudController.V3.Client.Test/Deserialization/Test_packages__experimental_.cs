      ...
      ""_links"": {
        ...
        ""app"": {
          ""href"": ""/v3/apps/guid-c375fd16-bd5d-4b42-8d5b-44374e639475""
            ...
            Assert.AreEqual("guid-876c0126-beb8-498c-b03d-63b8aedb2296", TestUtil.ToTestableString(page[0].Guid), true);
            ...
            Assert.AreEqual("guid-9a7163ed-4ba4-4e9e-997f-54fb6dde5486", TestUtil.ToTestableString(page[1].Guid), true);
            ...
            Assert.AreEqual("2015-06-30T07:10:53Z", TestUtil.ToTestableString(page[1].CreatedAt), true);
