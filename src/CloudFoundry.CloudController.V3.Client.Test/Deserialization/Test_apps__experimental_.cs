      ...
      ""links"": {
        ...
        ""assign_current_droplet"": {
          ...
          ""method"": ""PUT""
            ...
            Assert.AreEqual("d54bf89f-8096-43b0-95a2-fc31945bb5fa", TestUtil.ToTestableString(page[0].Guid), true);
            ...
            Assert.AreEqual("d54bf89f-8096-43b0-95a2-fc31945bb5fa", TestUtil.ToTestableString(page[1].Guid), true);
      ...
      ""links"": {
        ...
        ""assign_current_droplet"": {
          ...
          ""method"": ""PUT""
            ...
            Assert.AreEqual("26b604bf-678d-438f-8913-cde1f44358ea", TestUtil.ToTestableString(page[0].Guid), true);
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].UpdatedAt), true);
            Assert.AreEqual("26b604bf-678d-438f-8913-cde1f44358ea", TestUtil.ToTestableString(page[1].Guid), true);
      ...
      ""links"": {
        ...
        ""buildpack"": {
          ""href"": ""/v2/buildpacks/dc81415e-a557-4a31-9cae-5ea5cb29e020""
            ...
            Assert.AreEqual("3aaa8179-fad8-4682-97a6-67d299d24ee3", TestUtil.ToTestableString(page[0].Guid), true);
            Assert.AreEqual("STAGED", TestUtil.ToTestableString(page[0].State), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].Error), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].MemoryLimit), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].DiskLimit), true);
            Assert.AreEqual("1970-01-01T00:00:02Z", TestUtil.ToTestableString(page[0].CreatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].UpdatedAt), true);
            Assert.AreEqual("3aaa8179-fad8-4682-97a6-67d299d24ee3", TestUtil.ToTestableString(page[1].Guid), true);
      ...
      ""links"": {
        ...
        ""app"": {
          ""href"": ""/v3/apps/4a217abc-d05e-4708-8aee-d31d7c32dd63""
            ...
            Assert.AreEqual("8b1512d2-be83-4a11-b7a1-d06a9fcdd239", TestUtil.ToTestableString(page[0].Guid), true);
      ...
      ""links"": {
        ...
        ""space"": {
          ""href"": ""/v2/spaces/a0ed7cb6-d83f-4db1-b5cf-4b2a0a44054d""
            ...
            Assert.AreEqual("df228ebf-b611-4e04-9b56-6fb254d72845", TestUtil.ToTestableString(page[0].Guid), true);
            ...
            Assert.AreEqual("2016-07-07T09:16:54Z", TestUtil.ToTestableString(page[0].CreatedAt), true);
            Assert.AreEqual("2016-07-07T09:16:54Z", TestUtil.ToTestableString(page[0].UpdatedAt), true);
        }
