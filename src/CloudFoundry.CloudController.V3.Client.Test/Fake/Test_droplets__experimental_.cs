      ...
      ""links"": {
        ...
        ""assign_current_droplet"": {
          ...
          ""method"": ""PUT""
                ...
                Assert.AreEqual("1c5b5cdd-ae53-449e-8175-5a80880a029b", TestUtil.ToTestableString(obj[0].Guid), true);
                ...
                Assert.AreEqual("1c5b5cdd-ae53-449e-8175-5a80880a029b", TestUtil.ToTestableString(obj[1].Guid), true);
      ...
      ""links"": {
        ...
        ""buildpack"": {
          ""href"": ""/v2/buildpacks/b72a779c-29e8-47d2-9e0e-d3d638b9158b""
                ...
                Assert.AreEqual("14a47ed7-79ca-4d00-91c7-89fca182766e", TestUtil.ToTestableString(obj[0].Guid), true);
                Assert.AreEqual("STAGED", TestUtil.ToTestableString(obj[0].State), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].Error), true);
                Assert.AreEqual("123", TestUtil.ToTestableString(obj[0].MemoryLimit), true);
                Assert.AreEqual("456", TestUtil.ToTestableString(obj[0].DiskLimit), true);
                Assert.AreEqual("1970-01-01T00:00:02Z", TestUtil.ToTestableString(obj[0].CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].UpdatedAt), true);
                Assert.AreEqual("14a47ed7-79ca-4d00-91c7-89fca182766e", TestUtil.ToTestableString(obj[1].Guid), true);
