...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V3.Client.DropletsExperimentalEndpoint.FiltersDropletsByStates()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/233/droplets__experimental_/filters_droplets_by_states.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class FiltersDropletsByStatesResponse : CloudFoundry.CloudController.V3.Client.Data.Base.AbstractFiltersDropletsByStatesResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V3.Client.DropletsExperimentalEndpoint.FiltersDropletsByStates()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/233/droplets__experimental_/filters_droplets_by_states.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractFiltersDropletsByStatesResponse
    {
