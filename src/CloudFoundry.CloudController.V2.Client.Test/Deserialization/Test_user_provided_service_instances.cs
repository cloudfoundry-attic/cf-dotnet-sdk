  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instance_url"": ""/v2/user_provided_service_instances/79c36bc4-f3b9-4233-8c84-27a31eebe4c6""
            ...
            Assert.AreEqual("04c9fefa-b022-493c-afea-dcf7bcb4db32", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/service_bindings/04c9fefa-b022-493c-afea-dcf7bcb4db32", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2015-05-19T15:27:04+00:00", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("27294b61-2ca7-4f31-9237-c97cb8422b44", TestUtil.ToTestableString(page[0].AppGuid), true);
            Assert.AreEqual("79c36bc4-f3b9-4233-8c84-27a31eebe4c6", TestUtil.ToTestableString(page[0].ServiceInstanceGuid), true);
            ...
            Assert.AreEqual("/v2/apps/27294b61-2ca7-4f31-9237-c97cb8422b44", TestUtil.ToTestableString(page[0].AppUrl), true);
            Assert.AreEqual("/v2/user_provided_service_instances/79c36bc4-f3b9-4233-8c84-27a31eebe4c6", TestUtil.ToTestableString(page[0].ServiceInstanceUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_bindings_url"": ""/v2/user_provided_service_instances/64df917e-c3bd-4e64-8a64-94f772bd4741/service_bindings""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("64df917e-c3bd-4e64-8a64-94f772bd4741", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/user_provided_service_instances/64df917e-c3bd-4e64-8a64-94f772bd4741", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2015-05-19T15:27:04+00:00", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("name-96", TestUtil.ToTestableString(page[0].Name), true);
            Assert.AreEqual("143079ec-dfc1-4ae8-914a-fcd3bc200ecf", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            Assert.AreEqual("user_provided_service_instance", TestUtil.ToTestableString(page[0].Type), true);
            Assert.AreEqual("https://foo.com/url-9", TestUtil.ToTestableString(page[0].SyslogDrainUrl), true);
            Assert.AreEqual("/v2/spaces/143079ec-dfc1-4ae8-914a-fcd3bc200ecf", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/user_provided_service_instances/64df917e-c3bd-4e64-8a64-94f772bd4741/service_bindings", TestUtil.ToTestableString(page[0].ServiceBindingsUrl), true);
        }
