  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""apps_url"": ""/v2/routes/0b8399b6-ac4d-4866-a8dc-8e277ee76140/apps""
            ...
            Assert.AreEqual("e32e3875-43cd-4fbc-adbf-b5c5ae6a873e", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/routes/0b8399b6-ac4d-4866-a8dc-8e277ee76140", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2016-03-21T10:59:34Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("2016-03-21T10:59:34Z", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            ...
            Assert.AreEqual("e32e3875-43cd-4fbc-adbf-b5c5ae6a873e", TestUtil.ToTestableString(page[0].DomainGuid), true);
            Assert.AreEqual("e32e3875-43cd-4fbc-adbf-b5c5ae6a873e", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            Assert.AreEqual("e32e3875-43cd-4fbc-adbf-b5c5ae6a873e", TestUtil.ToTestableString(page[0].ServiceInstanceGuid), true);
            Assert.AreEqual("0", TestUtil.ToTestableString(page[0].Port), true);
            Assert.AreEqual("/v2/domains/f8c2280e-33d4-43a4-9489-1c704127eaff", TestUtil.ToTestableString(page[0].DomainUrl), true);
            Assert.AreEqual("/v2/spaces/fe06ea9e-ea03-4d89-ab22-179632222fe5", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/user_provided_service_instances/7fae6969-b5a7-424c-a6bf-53ab899c1eca", TestUtil.ToTestableString(page[0].ServiceInstanceUrl), true);
            Assert.AreEqual("/v2/routes/0b8399b6-ac4d-4866-a8dc-8e277ee76140/apps", TestUtil.ToTestableString(page[0].AppsUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""routes_url"": ""/v2/user_provided_service_instances/ff617efb-e6d0-41d3-b686-644e72fd7252/routes""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("ce3f33d8-4238-4bec-b8bc-bc00b436373f", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/user_provided_service_instances/ff617efb-e6d0-41d3-b686-644e72fd7252", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2016-03-21T10:59:34Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("name-817", TestUtil.ToTestableString(page[0].Name), true);
            Assert.AreEqual("ce3f33d8-4238-4bec-b8bc-bc00b436373f", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            ...
            Assert.AreEqual("/v2/spaces/6ac434a0-0c3f-4d25-a470-3b689ac0f5ee", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/user_provided_service_instances/ff617efb-e6d0-41d3-b686-644e72fd7252/service_bindings", TestUtil.ToTestableString(page[0].ServiceBindingsUrl), true);
            Assert.AreEqual("/v2/user_provided_service_instances/ff617efb-e6d0-41d3-b686-644e72fd7252/routes", TestUtil.ToTestableString(page[0].RoutesUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instance_url"": ""/v2/user_provided_service_instances/24415cc3-9063-4d4b-8176-2d4c03619517""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("76bc7473-d1b7-4ce2-8313-33bb863f54d6", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/service_bindings/0cd4ddec-97a4-4369-a5b3-6055163cdbf5", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2016-03-21T10:59:34Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("76bc7473-d1b7-4ce2-8313-33bb863f54d6", TestUtil.ToTestableString(page[0].AppGuid), true);
            Assert.AreEqual("76bc7473-d1b7-4ce2-8313-33bb863f54d6", TestUtil.ToTestableString(page[0].ServiceInstanceGuid), true);
            ...
            Assert.AreEqual("/v2/apps/9c60b46e-5f68-4389-98cd-d8f048771816", TestUtil.ToTestableString(page[0].AppUrl), true);
            Assert.AreEqual("/v2/user_provided_service_instances/24415cc3-9063-4d4b-8176-2d4c03619517", TestUtil.ToTestableString(page[0].ServiceInstanceUrl), true);
        }
