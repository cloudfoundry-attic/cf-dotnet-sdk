    ...
    },
    {
      ...
      ""entity"": {
        ...
        ""routes_url"": ""/v2/apps/f4b5ad49-7224-459a-8fb5-2a85a13c3010/routes""
            ...
            Assert.AreEqual("bb5631ca-6a96-4d1d-a77f-95d55de54341", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/apps/b337974b-4ccb-4b5c-87d6-1ea7293b930a", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2016-07-07T09:17:00Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("2016-07-07T09:17:00Z", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("name-1553", TestUtil.ToTestableString(page[0].Name), true);
            Assert.AreEqual("false", TestUtil.ToTestableString(page[0].Production), true);
            Assert.AreEqual("bb5631ca-6a96-4d1d-a77f-95d55de54341", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            Assert.AreEqual("bb5631ca-6a96-4d1d-a77f-95d55de54341", TestUtil.ToTestableString(page[0].StackGuid), true);
            ...
            Assert.AreEqual("a5c87fea-1331-4f03-b2ab-a5a2d3c40e83", TestUtil.ToTestableString(page[0].Version), true);
            ...
            Assert.AreEqual("2016-07-07T09:17:00Z", TestUtil.ToTestableString(page[0].PackageUpdatedAt), true);
            ...
            Assert.AreEqual("/v2/spaces/a8c673d5-2791-4fb7-9a2d-de8c05e41b69", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/stacks/33dca8d6-ae08-432a-a9b5-1d9b53ec13b2", TestUtil.ToTestableString(page[0].StackUrl), true);
            Assert.AreEqual("/v2/apps/b337974b-4ccb-4b5c-87d6-1ea7293b930a/events", TestUtil.ToTestableString(page[0].EventsUrl), true);
            Assert.AreEqual("/v2/apps/b337974b-4ccb-4b5c-87d6-1ea7293b930a/service_bindings", TestUtil.ToTestableString(page[0].ServiceBindingsUrl), true);
            Assert.AreEqual("/v2/apps/b337974b-4ccb-4b5c-87d6-1ea7293b930a/routes", TestUtil.ToTestableString(page[0].RoutesUrl), true);
            Assert.AreEqual("bb5631ca-6a96-4d1d-a77f-95d55de54341", TestUtil.ToTestableString(page[1].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/apps/dcd4e28c-1279-45fa-9638-daa139b253f8", TestUtil.ToTestableString(page[1].EntityMetadata.Url), true);
            Assert.AreEqual("2016-07-07T09:17:00Z", TestUtil.ToTestableString(page[1].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("2016-07-07T09:17:00Z", TestUtil.ToTestableString(page[1].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("name-1548", TestUtil.ToTestableString(page[1].Name), true);
            Assert.AreEqual("false", TestUtil.ToTestableString(page[1].Production), true);
            Assert.AreEqual("bb5631ca-6a96-4d1d-a77f-95d55de54341", TestUtil.ToTestableString(page[1].SpaceGuid), true);
            Assert.AreEqual("bb5631ca-6a96-4d1d-a77f-95d55de54341", TestUtil.ToTestableString(page[1].StackGuid), true);
            ...
            Assert.AreEqual("85e60e13-2bd9-4a2d-ad95-82c20ccbd7f8", TestUtil.ToTestableString(page[1].Version), true);
            ...
            Assert.AreEqual("2016-07-07T09:17:00Z", TestUtil.ToTestableString(page[1].PackageUpdatedAt), true);
            ...
            Assert.AreEqual("/v2/spaces/c18abba2-f512-45b6-8fd2-af21413464cd", TestUtil.ToTestableString(page[1].SpaceUrl), true);
            Assert.AreEqual("/v2/stacks/d37183b1-d667-4ee5-a7c0-36e015957124", TestUtil.ToTestableString(page[1].StackUrl), true);
            Assert.AreEqual("/v2/apps/dcd4e28c-1279-45fa-9638-daa139b253f8/events", TestUtil.ToTestableString(page[1].EventsUrl), true);
            Assert.AreEqual("/v2/apps/dcd4e28c-1279-45fa-9638-daa139b253f8/service_bindings", TestUtil.ToTestableString(page[1].ServiceBindingsUrl), true);
            Assert.AreEqual("/v2/apps/dcd4e28c-1279-45fa-9638-daa139b253f8/routes", TestUtil.ToTestableString(page[1].RoutesUrl), true);
            Assert.AreEqual("bb5631ca-6a96-4d1d-a77f-95d55de54341", TestUtil.ToTestableString(page[2].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/apps/f4b5ad49-7224-459a-8fb5-2a85a13c3010", TestUtil.ToTestableString(page[2].EntityMetadata.Url), true);
            Assert.AreEqual("2016-07-07T09:17:00Z", TestUtil.ToTestableString(page[2].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("2016-07-07T09:17:00Z", TestUtil.ToTestableString(page[2].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("name-1558", TestUtil.ToTestableString(page[2].Name), true);
            Assert.AreEqual("false", TestUtil.ToTestableString(page[2].Production), true);
            Assert.AreEqual("bb5631ca-6a96-4d1d-a77f-95d55de54341", TestUtil.ToTestableString(page[2].SpaceGuid), true);
            Assert.AreEqual("bb5631ca-6a96-4d1d-a77f-95d55de54341", TestUtil.ToTestableString(page[2].StackGuid), true);
            ...
            Assert.AreEqual("c5fe9d62-aa24-4932-9f8d-4a9e1fbc7d57", TestUtil.ToTestableString(page[2].Version), true);
            ...
            Assert.AreEqual("2016-07-07T09:17:00Z", TestUtil.ToTestableString(page[2].PackageUpdatedAt), true);
            ...
            Assert.AreEqual("/v2/spaces/18ab588f-530b-4670-a9a0-ab2a3a47e16d", TestUtil.ToTestableString(page[2].SpaceUrl), true);
            Assert.AreEqual("/v2/stacks/bd69f6c7-36b5-4f3a-86ab-631cc9cec2f2", TestUtil.ToTestableString(page[2].StackUrl), true);
            Assert.AreEqual("/v2/apps/f4b5ad49-7224-459a-8fb5-2a85a13c3010/events", TestUtil.ToTestableString(page[2].EventsUrl), true);
            Assert.AreEqual("/v2/apps/f4b5ad49-7224-459a-8fb5-2a85a13c3010/service_bindings", TestUtil.ToTestableString(page[2].ServiceBindingsUrl), true);
            Assert.AreEqual("/v2/apps/f4b5ad49-7224-459a-8fb5-2a85a13c3010/routes", TestUtil.ToTestableString(page[2].RoutesUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""apps_url"": ""/v2/routes/f5f1673c-03d6-48c3-93e0-cbb098543dd7/apps""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("3ce6476a-d42d-4404-8074-637538525e5f", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/routes/f5f1673c-03d6-48c3-93e0-cbb098543dd7", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            ...
            Assert.AreEqual("3ce6476a-d42d-4404-8074-637538525e5f", TestUtil.ToTestableString(page[0].DomainGuid), true);
            Assert.AreEqual("3ce6476a-d42d-4404-8074-637538525e5f", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            ...
            Assert.AreEqual("/v2/domains/7d3fb969-e861-4de7-bf6d-72fdc4cda0b8", TestUtil.ToTestableString(page[0].DomainUrl), true);
            Assert.AreEqual("/v2/spaces/679a9388-944e-4150-9038-1bb00a0157bb", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/routes/f5f1673c-03d6-48c3-93e0-cbb098543dd7/apps", TestUtil.ToTestableString(page[0].AppsUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instance_url"": ""/v2/service_instances/e286e2d6-dcd2-4aa1-bb66-4bc2ef6c83bf""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("b59ab2da-6436-4dcf-ac96-6a6f1f197ea9", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/service_bindings/a25c317f-e97a-4741-96f5-a262a4b9606c", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2016-07-07T09:17:01Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("b59ab2da-6436-4dcf-ac96-6a6f1f197ea9", TestUtil.ToTestableString(page[0].AppGuid), true);
            Assert.AreEqual("b59ab2da-6436-4dcf-ac96-6a6f1f197ea9", TestUtil.ToTestableString(page[0].ServiceInstanceGuid), true);
            ...
            Assert.AreEqual("/v2/apps/843ef93c-563d-41d3-966f-9a9c645c3aa6", TestUtil.ToTestableString(page[0].AppUrl), true);
            Assert.AreEqual("/v2/service_instances/e286e2d6-dcd2-4aa1-bb66-4bc2ef6c83bf", TestUtil.ToTestableString(page[0].ServiceInstanceUrl), true);
        }
