  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_bindings_url"": ""/v2/service_instances/afd3323a-6949-49f8-9f71-45eaf7325202/service_bindings""
            ...
            Assert.AreEqual("afd3323a-6949-49f8-9f71-45eaf7325202", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/service_instances/afd3323a-6949-49f8-9f71-45eaf7325202", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2015-05-19T15:27:16+00:00", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("name-1494", TestUtil.ToTestableString(page[0].Name), true);
            Assert.AreEqual("86fbbc62-4fbb-4f5c-abc0-0d6e490945c0", TestUtil.ToTestableString(page[0].ServicePlanGuid), true);
            Assert.AreEqual("7f512e18-d2e0-484f-92f8-2278420a6099", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            ...
            Assert.AreEqual("/v2/spaces/7f512e18-d2e0-484f-92f8-2278420a6099", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/service_plans/86fbbc62-4fbb-4f5c-abc0-0d6e490945c0", TestUtil.ToTestableString(page[0].ServicePlanUrl), true);
            Assert.AreEqual("/v2/service_instances/afd3323a-6949-49f8-9f71-45eaf7325202/service_bindings", TestUtil.ToTestableString(page[0].ServiceBindingsUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instance_url"": ""/v2/service_instances/9e5d5afd-9211-4033-9002-6c290692b9cc""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("3f0462e7-179e-4e45-96c3-d43851c8d0fd", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/service_bindings/3f0462e7-179e-4e45-96c3-d43851c8d0fd", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2015-05-19T15:27:16+00:00", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("5eb2f940-fd3a-4837-98cc-9e65bc10a483", TestUtil.ToTestableString(page[0].AppGuid), true);
            Assert.AreEqual("9e5d5afd-9211-4033-9002-6c290692b9cc", TestUtil.ToTestableString(page[0].ServiceInstanceGuid), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].GatewayData), true);
            ...
            Assert.AreEqual("/v2/apps/5eb2f940-fd3a-4837-98cc-9e65bc10a483", TestUtil.ToTestableString(page[0].AppUrl), true);
            Assert.AreEqual("/v2/service_instances/9e5d5afd-9211-4033-9002-6c290692b9cc", TestUtil.ToTestableString(page[0].ServiceInstanceUrl), true);
        }
