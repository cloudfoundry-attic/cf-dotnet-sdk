  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""route_mappings_url"": ""/v2/routes/582dc993-3128-4a76-9874-aa8e8c4b836e/route_mappings""
            ...
            Assert.AreEqual("1a597ba6-26f2-4744-939e-410d74a787b2", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/routes/582dc993-3128-4a76-9874-aa8e8c4b836e", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2016-09-02T11:52:07Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            ...
            Assert.AreEqual("1a597ba6-26f2-4744-939e-410d74a787b2", TestUtil.ToTestableString(page[0].DomainGuid), true);
            Assert.AreEqual("1a597ba6-26f2-4744-939e-410d74a787b2", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            Assert.AreEqual("1a597ba6-26f2-4744-939e-410d74a787b2", TestUtil.ToTestableString(page[0].ServiceInstanceGuid), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].Port), true);
            Assert.AreEqual("/v2/private_domains/09040a7e-3b3c-41dc-8f1a-ff8c2dc0b729", TestUtil.ToTestableString(page[0].DomainUrl), true);
            Assert.AreEqual("/v2/spaces/1dee9a15-aeea-4863-a3ac-69667a2392e2", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/service_instances/278512a7-ea77-4ed2-9fc6-cb6745da022d", TestUtil.ToTestableString(page[0].ServiceInstanceUrl), true);
            Assert.AreEqual("/v2/routes/582dc993-3128-4a76-9874-aa8e8c4b836e/apps", TestUtil.ToTestableString(page[0].AppsUrl), true);
            Assert.AreEqual("/v2/routes/582dc993-3128-4a76-9874-aa8e8c4b836e/route_mappings", TestUtil.ToTestableString(page[0].RouteMappingsUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""routes_url"": ""/v2/service_instances/49c799f2-f5fb-47ce-8b62-e20e80380284/routes""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("d73e2744-4fe1-4197-bf73-fb989050a8c4", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/service_instances/49c799f2-f5fb-47ce-8b62-e20e80380284", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2016-09-02T11:52:08Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("name-707", TestUtil.ToTestableString(page[0].Name), true);
            Assert.AreEqual("d73e2744-4fe1-4197-bf73-fb989050a8c4", TestUtil.ToTestableString(page[0].ServicePlanGuid), true);
            Assert.AreEqual("d73e2744-4fe1-4197-bf73-fb989050a8c4", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            ...
            Assert.AreEqual("/v2/spaces/fd27c08f-729f-43f6-bb7f-7c6c1f30bef3", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/service_plans/774277d7-716c-45d9-a35c-8f9b22717c1d", TestUtil.ToTestableString(page[0].ServicePlanUrl), true);
            Assert.AreEqual("/v2/service_instances/49c799f2-f5fb-47ce-8b62-e20e80380284/service_bindings", TestUtil.ToTestableString(page[0].ServiceBindingsUrl), true);
            Assert.AreEqual("/v2/service_instances/49c799f2-f5fb-47ce-8b62-e20e80380284/service_keys", TestUtil.ToTestableString(page[0].ServiceKeysUrl), true);
            Assert.AreEqual("/v2/service_instances/49c799f2-f5fb-47ce-8b62-e20e80380284/routes", TestUtil.ToTestableString(page[0].RoutesUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instance_url"": ""/v2/service_instances/064e4748-ba56-40ff-b881-a86f03c7a27c""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("dcfb8bf7-95fe-4fa7-b972-a3bbb39ce4d6", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/service_keys/9664bd30-bc55-4884-a87c-73e48c17f3bd", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2016-09-02T11:52:07Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("a-service-key", TestUtil.ToTestableString(page[0].Name), true);
            Assert.AreEqual("dcfb8bf7-95fe-4fa7-b972-a3bbb39ce4d6", TestUtil.ToTestableString(page[0].ServiceInstanceGuid), true);
            Assert.AreEqual("/v2/service_instances/064e4748-ba56-40ff-b881-a86f03c7a27c", TestUtil.ToTestableString(page[0].ServiceInstanceUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instance_url"": ""/v2/service_instances/b03543bc-6552-470e-85df-a94b8c1de8bd""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("b81d4e1c-4f75-4ab9-a860-3be3839b2efd", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/service_bindings/dffadc0d-cb88-4e0f-ab25-487bcd74baa1", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2016-09-02T11:52:07Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("b81d4e1c-4f75-4ab9-a860-3be3839b2efd", TestUtil.ToTestableString(page[0].AppGuid), true);
            Assert.AreEqual("b81d4e1c-4f75-4ab9-a860-3be3839b2efd", TestUtil.ToTestableString(page[0].ServiceInstanceGuid), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].GatewayData), true);
            ...
            Assert.AreEqual("/v2/apps/97afa2eb-9e73-4ab0-97ce-17461f96f736", TestUtil.ToTestableString(page[0].AppUrl), true);
            Assert.AreEqual("/v2/service_instances/b03543bc-6552-470e-85df-a94b8c1de8bd", TestUtil.ToTestableString(page[0].ServiceInstanceUrl), true);
        }
