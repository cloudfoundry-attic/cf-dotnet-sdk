  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_url"": ""/v2/services/2c1e40e0-ed71-46ee-9aea-b93cb5a241df""
            ...
            Assert.AreEqual("3ae9a24f-8012-408c-986b-38439646f1f2", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/service_instances/b036c1cb-8ab1-492f-9a26-9f73d21fdb29", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2017-01-04T15:59:02Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("2017-01-04T15:59:02Z", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("name-2266", TestUtil.ToTestableString(page[0].Name), true);
            Assert.AreEqual("3ae9a24f-8012-408c-986b-38439646f1f2", TestUtil.ToTestableString(page[0].ServicePlanGuid), true);
            Assert.AreEqual("3ae9a24f-8012-408c-986b-38439646f1f2", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            ...
            Assert.AreEqual("3ae9a24f-8012-408c-986b-38439646f1f2", TestUtil.ToTestableString(page[0].ServiceGuid), true);
            Assert.AreEqual("/v2/spaces/b8afcf86-b02c-4b78-aa70-c7e7275e8780", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/service_plans/38382d19-0101-47ad-b6dd-df9059b253fe", TestUtil.ToTestableString(page[0].ServicePlanUrl), true);
            Assert.AreEqual("/v2/service_instances/b036c1cb-8ab1-492f-9a26-9f73d21fdb29/service_bindings", TestUtil.ToTestableString(page[0].ServiceBindingsUrl), true);
            Assert.AreEqual("/v2/service_instances/b036c1cb-8ab1-492f-9a26-9f73d21fdb29/service_keys", TestUtil.ToTestableString(page[0].ServiceKeysUrl), true);
            Assert.AreEqual("/v2/service_instances/b036c1cb-8ab1-492f-9a26-9f73d21fdb29/routes", TestUtil.ToTestableString(page[0].RoutesUrl), true);
            Assert.AreEqual("/v2/services/2c1e40e0-ed71-46ee-9aea-b93cb5a241df", TestUtil.ToTestableString(page[0].ServiceUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instance_url"": ""/v2/service_instances/eb8021f6-c5ef-4f61-8ecf-212affe771b8""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("b38a9ed5-9589-47a1-bf38-4af742cc315e", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/service_bindings/004538e0-c4aa-4820-abb7-f6d5ae20aca5", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2017-01-04T15:59:02Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("2017-01-04T15:59:02Z", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("b38a9ed5-9589-47a1-bf38-4af742cc315e", TestUtil.ToTestableString(page[0].AppGuid), true);
            Assert.AreEqual("b38a9ed5-9589-47a1-bf38-4af742cc315e", TestUtil.ToTestableString(page[0].ServiceInstanceGuid), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].GatewayData), true);
            ...
            Assert.AreEqual("/v2/service_instances/eb8021f6-c5ef-4f61-8ecf-212affe771b8", TestUtil.ToTestableString(page[0].ServiceInstanceUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""route_mappings_url"": ""/v2/routes/4f704ec5-7c62-4e5e-8c2b-558a59821661/route_mappings""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("670b1ec5-da53-4668-897b-637d9813a99c", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/routes/4f704ec5-7c62-4e5e-8c2b-558a59821661", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            ...
            Assert.AreEqual("host-26", TestUtil.ToTestableString(page[0].Host), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].Path), true);
            Assert.AreEqual("670b1ec5-da53-4668-897b-637d9813a99c", TestUtil.ToTestableString(page[0].DomainGuid), true);
            Assert.AreEqual("670b1ec5-da53-4668-897b-637d9813a99c", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            Assert.AreEqual("670b1ec5-da53-4668-897b-637d9813a99c", TestUtil.ToTestableString(page[0].ServiceInstanceGuid), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].Port), true);
            Assert.AreEqual("/v2/private_domains/bb6caf95-6fc9-4061-95f4-a3131106b933", TestUtil.ToTestableString(page[0].DomainUrl), true);
            Assert.AreEqual("/v2/spaces/301a314f-6ee7-428e-8eaa-68dd9b70b2f6", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/service_instances/7bbe78d8-c72f-451c-a922-a1f6adfd2d7f", TestUtil.ToTestableString(page[0].ServiceInstanceUrl), true);
            Assert.AreEqual("/v2/routes/4f704ec5-7c62-4e5e-8c2b-558a59821661/apps", TestUtil.ToTestableString(page[0].AppsUrl), true);
            Assert.AreEqual("/v2/routes/4f704ec5-7c62-4e5e-8c2b-558a59821661/route_mappings", TestUtil.ToTestableString(page[0].RouteMappingsUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instance_url"": ""/v2/service_instances/c18326f6-9114-40b9-b7e7-6f259a665774""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("9a464f9d-ec1f-4920-823f-59e9ab10226c", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/service_keys/a7607a80-0e77-4519-94b4-bfdbd3d503f1", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2017-01-04T15:59:02Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("2017-01-04T15:59:02Z", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("a-service-key", TestUtil.ToTestableString(page[0].Name), true);
            Assert.AreEqual("9a464f9d-ec1f-4920-823f-59e9ab10226c", TestUtil.ToTestableString(page[0].ServiceInstanceGuid), true);
            Assert.AreEqual("/v2/service_instances/c18326f6-9114-40b9-b7e7-6f259a665774", TestUtil.ToTestableString(page[0].ServiceInstanceUrl), true);
        }
