  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""route_mappings_url"": ""/v2/apps/bdd71c69-8c2e-4a67-b443-016d5de04288/route_mappings""
            ...
            Assert.AreEqual("6bda6d68-21b9-4486-89cf-da35f1f2eb2c", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/apps/bdd71c69-8c2e-4a67-b443-016d5de04288", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2017-01-04T15:58:55Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("2017-01-04T15:58:55Z", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            Assert.AreEqual("name-1906", TestUtil.ToTestableString(page[0].Name), true);
            Assert.AreEqual("false", TestUtil.ToTestableString(page[0].Production), true);
            Assert.AreEqual("6bda6d68-21b9-4486-89cf-da35f1f2eb2c", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            Assert.AreEqual("6bda6d68-21b9-4486-89cf-da35f1f2eb2c", TestUtil.ToTestableString(page[0].StackGuid), true);
            ...
            Assert.AreEqual("4d8c76d4-439d-45f7-9ccb-c884b7153a2c", TestUtil.ToTestableString(page[0].Version), true);
            ...
            Assert.AreEqual("2a965df8-0c0e-476d-af95-e3c94ae262f0", TestUtil.ToTestableString(page[0].StagingTaskId), true);
            ...
            Assert.AreEqual("2017-01-04T15:58:54Z", TestUtil.ToTestableString(page[0].PackageUpdatedAt), true);
            ...
            Assert.AreEqual("/v2/spaces/8b3c9652-7d26-40bf-92f8-222ddbda1de3", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/stacks/0fc9cb17-6b5c-441d-a89c-271745f3ec71", TestUtil.ToTestableString(page[0].StackUrl), true);
            Assert.AreEqual("/v2/apps/bdd71c69-8c2e-4a67-b443-016d5de04288/routes", TestUtil.ToTestableString(page[0].RoutesUrl), true);
            Assert.AreEqual("/v2/apps/bdd71c69-8c2e-4a67-b443-016d5de04288/events", TestUtil.ToTestableString(page[0].EventsUrl), true);
            Assert.AreEqual("/v2/apps/bdd71c69-8c2e-4a67-b443-016d5de04288/service_bindings", TestUtil.ToTestableString(page[0].ServiceBindingsUrl), true);
            Assert.AreEqual("/v2/apps/bdd71c69-8c2e-4a67-b443-016d5de04288/route_mappings", TestUtil.ToTestableString(page[0].RouteMappingsUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""route_mappings_url"": ""/v2/routes/ab0c543e-1e4d-4a5c-b120-13f992a8eb77/route_mappings""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("96cdbe58-58e3-467e-b5ed-ea6de012f026", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/routes/ab0c543e-1e4d-4a5c-b120-13f992a8eb77", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2017-01-04T15:58:56Z", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("2017-01-04T15:58:56Z", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            ...
            Assert.AreEqual("96cdbe58-58e3-467e-b5ed-ea6de012f026", TestUtil.ToTestableString(page[0].DomainGuid), true);
            Assert.AreEqual("96cdbe58-58e3-467e-b5ed-ea6de012f026", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            Assert.AreEqual("96cdbe58-58e3-467e-b5ed-ea6de012f026", TestUtil.ToTestableString(page[0].ServiceInstanceGuid), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].Port), true);
            Assert.AreEqual("/v2/shared_domains/0b94469d-8f91-4a26-9ac7-d528b30f1b37", TestUtil.ToTestableString(page[0].DomainUrl), true);
            Assert.AreEqual("/v2/spaces/b68f3a65-60d0-42d0-b1de-bc5083324048", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/service_instances/349eb01c-45eb-4f33-b614-9a8d392a54ae", TestUtil.ToTestableString(page[0].ServiceInstanceUrl), true);
            Assert.AreEqual("/v2/routes/ab0c543e-1e4d-4a5c-b120-13f992a8eb77/apps", TestUtil.ToTestableString(page[0].AppsUrl), true);
            Assert.AreEqual("/v2/routes/ab0c543e-1e4d-4a5c-b120-13f992a8eb77/route_mappings", TestUtil.ToTestableString(page[0].RouteMappingsUrl), true);
        }
