  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""apps_url"": ""/v2/routes/8015ceed-9d0f-4221-9bc0-4c1bc8e672c8/apps""
            ...
            Assert.AreEqual("8015ceed-9d0f-4221-9bc0-4c1bc8e672c8", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/routes/8015ceed-9d0f-4221-9bc0-4c1bc8e672c8", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            ...
            Assert.AreEqual("0426cc37-a225-498a-b433-1084e7aa3379", TestUtil.ToTestableString(page[0].DomainGuid), true);
            Assert.AreEqual("07453c83-035e-40c0-97ae-4468d275d8c6", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            Assert.AreEqual("/v2/domains/0426cc37-a225-498a-b433-1084e7aa3379", TestUtil.ToTestableString(page[0].DomainUrl), true);
            Assert.AreEqual("/v2/spaces/07453c83-035e-40c0-97ae-4468d275d8c6", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/routes/8015ceed-9d0f-4221-9bc0-4c1bc8e672c8/apps", TestUtil.ToTestableString(page[0].AppsUrl), true);
        }
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""routes_url"": ""/v2/apps/3424df8f-e177-4621-8a3f-d697ffcbec92/routes""
            ...
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.PreviousUrl), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page.Properties.NextUrl), true);
            Assert.AreEqual("3424df8f-e177-4621-8a3f-d697ffcbec92", TestUtil.ToTestableString(page[0].EntityMetadata.Guid), true);
            Assert.AreEqual("/v2/apps/3424df8f-e177-4621-8a3f-d697ffcbec92", TestUtil.ToTestableString(page[0].EntityMetadata.Url), true);
            Assert.AreEqual("2015-04-16T12:04:15+00:00", TestUtil.ToTestableString(page[0].EntityMetadata.CreatedAt), true);
            Assert.AreEqual("2015-04-16T12:04:15+00:00", TestUtil.ToTestableString(page[0].EntityMetadata.UpdatedAt), true);
            ...
            Assert.AreEqual("c9add357-d85d-496c-a62a-b3db70885264", TestUtil.ToTestableString(page[0].SpaceGuid), true);
            Assert.AreEqual("bc0d5492-7a00-413c-a749-6b80f9c28f9d", TestUtil.ToTestableString(page[0].StackGuid), true);
            ...
            Assert.AreEqual("8f316c21-8f0b-426a-bbd2-e88800c23e9d", TestUtil.ToTestableString(page[0].Version), true);
            ...
            Assert.AreEqual("2015-04-16T12:04:15+00:00", TestUtil.ToTestableString(page[0].PackageUpdatedAt), true);
            Assert.AreEqual("", TestUtil.ToTestableString(page[0].DetectedStartCommand), true);
            Assert.AreEqual("/v2/spaces/c9add357-d85d-496c-a62a-b3db70885264", TestUtil.ToTestableString(page[0].SpaceUrl), true);
            Assert.AreEqual("/v2/stacks/bc0d5492-7a00-413c-a749-6b80f9c28f9d", TestUtil.ToTestableString(page[0].StackUrl), true);
            Assert.AreEqual("/v2/apps/3424df8f-e177-4621-8a3f-d697ffcbec92/events", TestUtil.ToTestableString(page[0].EventsUrl), true);
            Assert.AreEqual("/v2/apps/3424df8f-e177-4621-8a3f-d697ffcbec92/service_bindings", TestUtil.ToTestableString(page[0].ServiceBindingsUrl), true);
            Assert.AreEqual("/v2/apps/3424df8f-e177-4621-8a3f-d697ffcbec92/routes", TestUtil.ToTestableString(page[0].RoutesUrl), true);
        }
