  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instances_url"": ""/v2/service_plans/9e68af4a-1cfb-4ec7-9a8c-ed6e4920e4b0/service_instances""
                ...
                Assert.AreEqual("6e264fbd-fffd-4875-9477-afb33d7a2fac", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_plans/9e68af4a-1cfb-4ec7-9a8c-ed6e4920e4b0", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-09-02T11:52:11Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-835", TestUtil.ToTestableString(obj[0].Name), true);
                ...
                Assert.AreEqual("6e264fbd-fffd-4875-9477-afb33d7a2fac", TestUtil.ToTestableString(obj[0].ServiceGuid), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].Extra), true);
                Assert.AreEqual("25c450cf-b1f6-40f2-a4bf-43eca6e97d0b", TestUtil.ToTestableString(obj[0].UniqueId), true);
                ...
                Assert.AreEqual("/v2/services/ac5d3650-c740-41e0-9bf1-408ccaa575f2", TestUtil.ToTestableString(obj[0].ServiceUrl), true);
                Assert.AreEqual("/v2/service_plans/9e68af4a-1cfb-4ec7-9a8c-ed6e4920e4b0/service_instances", TestUtil.ToTestableString(obj[0].ServiceInstancesUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""routes_url"": ""/v2/service_instances/0c60d298-5a49-4d78-a32a-524c36a2187f/routes""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("c798e5cf-2911-41f9-8bcd-a985bcae8230", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_instances/0c60d298-5a49-4d78-a32a-524c36a2187f", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-09-02T11:52:11Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-831", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("c798e5cf-2911-41f9-8bcd-a985bcae8230", TestUtil.ToTestableString(obj[0].ServicePlanGuid), true);
                Assert.AreEqual("c798e5cf-2911-41f9-8bcd-a985bcae8230", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                ...
                Assert.AreEqual("/v2/spaces/4129899c-1b4c-4dac-90ce-136dec00ad7f", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/service_plans/b5eccd59-3606-4179-aa1e-b7e2b484a2e5", TestUtil.ToTestableString(obj[0].ServicePlanUrl), true);
                Assert.AreEqual("/v2/service_instances/0c60d298-5a49-4d78-a32a-524c36a2187f/service_bindings", TestUtil.ToTestableString(obj[0].ServiceBindingsUrl), true);
                Assert.AreEqual("/v2/service_instances/0c60d298-5a49-4d78-a32a-524c36a2187f/service_keys", TestUtil.ToTestableString(obj[0].ServiceKeysUrl), true);
                Assert.AreEqual("/v2/service_instances/0c60d298-5a49-4d78-a32a-524c36a2187f/routes", TestUtil.ToTestableString(obj[0].RoutesUrl), true);
