  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""total_reserved_route_ports"": 0
                ...
                Assert.AreEqual("2e4037af-5fd7-48af-b37c-26b5739f53a3", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/quota_definitions/90c801d3-6fb3-4be2-9b55-cfe5bfc3b0c5", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
