  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""spaces_url"": ""/v2/space_quota_definitions/abd59e6b-98e1-4453-9993-7f3bfec05224/spaces""
                ...
                Assert.AreEqual("5205e564-85bc-48f7-af17-3e252271fc62", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/space_quota_definitions/abd59e6b-98e1-4453-9993-7f3bfec05224", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-07-07T09:17:19Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-2571", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("5205e564-85bc-48f7-af17-3e252271fc62", TestUtil.ToTestableString(obj[0].OrganizationGuid), true);
                ...
                Assert.AreEqual("/v2/organizations/85db4393-9732-49c6-8cfb-f8a3091133ac", TestUtil.ToTestableString(obj[0].OrganizationUrl), true);
                Assert.AreEqual("/v2/space_quota_definitions/abd59e6b-98e1-4453-9993-7f3bfec05224/spaces", TestUtil.ToTestableString(obj[0].SpacesUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""security_groups_url"": ""/v2/spaces/708c69ed-b82f-412f-b1bc-e37badbad43e/security_groups""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("73cb139a-acc7-4afa-ba26-3f2ef744893a", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/spaces/708c69ed-b82f-412f-b1bc-e37badbad43e", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-07-07T09:17:19Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("2016-07-07T09:17:19Z", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-2556", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("73cb139a-acc7-4afa-ba26-3f2ef744893a", TestUtil.ToTestableString(obj[0].OrganizationGuid), true);
                Assert.AreEqual("73cb139a-acc7-4afa-ba26-3f2ef744893a", TestUtil.ToTestableString(obj[0].SpaceQuotaDefinitionGuid), true);
                Assert.AreEqual("true", TestUtil.ToTestableString(obj[0].AllowSsh), true);
                Assert.AreEqual("/v2/organizations/457bc39a-199e-49dd-81fe-24ade9c4d216", TestUtil.ToTestableString(obj[0].OrganizationUrl), true);
                Assert.AreEqual("/v2/space_quota_definitions/9f88713f-282a-46da-b70a-be23889f33c7", TestUtil.ToTestableString(obj[0].SpaceQuotaDefinitionUrl), true);
                Assert.AreEqual("/v2/spaces/708c69ed-b82f-412f-b1bc-e37badbad43e/developers", TestUtil.ToTestableString(obj[0].DevelopersUrl), true);
                Assert.AreEqual("/v2/spaces/708c69ed-b82f-412f-b1bc-e37badbad43e/managers", TestUtil.ToTestableString(obj[0].ManagersUrl), true);
                Assert.AreEqual("/v2/spaces/708c69ed-b82f-412f-b1bc-e37badbad43e/auditors", TestUtil.ToTestableString(obj[0].AuditorsUrl), true);
                Assert.AreEqual("/v2/spaces/708c69ed-b82f-412f-b1bc-e37badbad43e/apps", TestUtil.ToTestableString(obj[0].AppsUrl), true);
                Assert.AreEqual("/v2/spaces/708c69ed-b82f-412f-b1bc-e37badbad43e/routes", TestUtil.ToTestableString(obj[0].RoutesUrl), true);
                Assert.AreEqual("/v2/spaces/708c69ed-b82f-412f-b1bc-e37badbad43e/domains", TestUtil.ToTestableString(obj[0].DomainsUrl), true);
                Assert.AreEqual("/v2/spaces/708c69ed-b82f-412f-b1bc-e37badbad43e/service_instances", TestUtil.ToTestableString(obj[0].ServiceInstancesUrl), true);
                Assert.AreEqual("/v2/spaces/708c69ed-b82f-412f-b1bc-e37badbad43e/app_events", TestUtil.ToTestableString(obj[0].AppEventsUrl), true);
                Assert.AreEqual("/v2/spaces/708c69ed-b82f-412f-b1bc-e37badbad43e/events", TestUtil.ToTestableString(obj[0].EventsUrl), true);
                Assert.AreEqual("/v2/spaces/708c69ed-b82f-412f-b1bc-e37badbad43e/security_groups", TestUtil.ToTestableString(obj[0].SecurityGroupsUrl), true);
