  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""security_groups_url"": ""/v2/spaces/dfc2c96a-f682-4561-a7fe-8b6f1894cb79/security_groups""
                ...
                Assert.AreEqual("f9ccfa00-c6c5-4943-89e1-12395f75ec25", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/spaces/dfc2c96a-f682-4561-a7fe-8b6f1894cb79", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-10-12T12:29:07Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("2016-10-12T12:29:08Z", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-10", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("f9ccfa00-c6c5-4943-89e1-12395f75ec25", TestUtil.ToTestableString(obj[0].OrganizationGuid), true);
                Assert.AreEqual("f9ccfa00-c6c5-4943-89e1-12395f75ec25", TestUtil.ToTestableString(obj[0].SpaceQuotaDefinitionGuid), true);
                ...
                Assert.AreEqual("/v2/organizations/64537dc0-fcf3-4ae4-b41a-4003cf1c259a", TestUtil.ToTestableString(obj[0].OrganizationUrl), true);
                Assert.AreEqual("/v2/space_quota_definitions/5929a076-b75a-4bce-9686-6cbbaeea4943", TestUtil.ToTestableString(obj[0].SpaceQuotaDefinitionUrl), true);
                Assert.AreEqual("/v2/spaces/dfc2c96a-f682-4561-a7fe-8b6f1894cb79/developers", TestUtil.ToTestableString(obj[0].DevelopersUrl), true);
                Assert.AreEqual("/v2/spaces/dfc2c96a-f682-4561-a7fe-8b6f1894cb79/managers", TestUtil.ToTestableString(obj[0].ManagersUrl), true);
                Assert.AreEqual("/v2/spaces/dfc2c96a-f682-4561-a7fe-8b6f1894cb79/auditors", TestUtil.ToTestableString(obj[0].AuditorsUrl), true);
                Assert.AreEqual("/v2/spaces/dfc2c96a-f682-4561-a7fe-8b6f1894cb79/apps", TestUtil.ToTestableString(obj[0].AppsUrl), true);
                Assert.AreEqual("/v2/spaces/dfc2c96a-f682-4561-a7fe-8b6f1894cb79/routes", TestUtil.ToTestableString(obj[0].RoutesUrl), true);
                Assert.AreEqual("/v2/spaces/dfc2c96a-f682-4561-a7fe-8b6f1894cb79/domains", TestUtil.ToTestableString(obj[0].DomainsUrl), true);
                Assert.AreEqual("/v2/spaces/dfc2c96a-f682-4561-a7fe-8b6f1894cb79/service_instances", TestUtil.ToTestableString(obj[0].ServiceInstancesUrl), true);
                Assert.AreEqual("/v2/spaces/dfc2c96a-f682-4561-a7fe-8b6f1894cb79/app_events", TestUtil.ToTestableString(obj[0].AppEventsUrl), true);
                Assert.AreEqual("/v2/spaces/dfc2c96a-f682-4561-a7fe-8b6f1894cb79/events", TestUtil.ToTestableString(obj[0].EventsUrl), true);
                Assert.AreEqual("/v2/spaces/dfc2c96a-f682-4561-a7fe-8b6f1894cb79/security_groups", TestUtil.ToTestableString(obj[0].SecurityGroupsUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""spaces_url"": ""/v2/space_quota_definitions/5f0b553d-d99d-49d6-9aee-bfa81304debf/spaces""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("09b2ca26-9eb9-4980-a000-3b7dac85e8e9", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/space_quota_definitions/5f0b553d-d99d-49d6-9aee-bfa81304debf", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                ...
                Assert.AreEqual("09b2ca26-9eb9-4980-a000-3b7dac85e8e9", TestUtil.ToTestableString(obj[0].OrganizationGuid), true);
                ...
                Assert.AreEqual("/v2/organizations/d8d0d293-b80c-42e0-92ce-dcf9d6651c2a", TestUtil.ToTestableString(obj[0].OrganizationUrl), true);
                Assert.AreEqual("/v2/space_quota_definitions/5f0b553d-d99d-49d6-9aee-bfa81304debf/spaces", TestUtil.ToTestableString(obj[0].SpacesUrl), true);
