  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_plans_url"": ""/v2/services/07265ace-1ff4-40b3-9779-5b6fe89ff1dd/service_plans""
                ...
                Assert.AreEqual("6becabd1-40ae-4743-b33d-639994727e4f", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/services/07265ace-1ff4-40b3-9779-5b6fe89ff1dd", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-11T13:20:32Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                ...
                Assert.AreEqual("desc-64", TestUtil.ToTestableString(obj[0].Description), true);
                ...
                Assert.AreEqual("e99ac008-54aa-4131-9acb-8c42b43e0133", TestUtil.ToTestableString(obj[0].UniqueId), true);
                ...
                Assert.AreEqual("6becabd1-40ae-4743-b33d-639994727e4f", TestUtil.ToTestableString(obj[0].ServiceBrokerGuid), true);
                Assert.AreEqual("false", TestUtil.ToTestableString(obj[0].PlanUpdateable), true);
                Assert.AreEqual("/v2/services/07265ace-1ff4-40b3-9779-5b6fe89ff1dd/service_plans", TestUtil.ToTestableString(obj[0].ServicePlansUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instances_url"": ""/v2/service_plans/f8ec9a8f-587d-4984-9049-100f3a2b074f/service_instances""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("ca2cf1af-d8a8-4592-9136-7f12dfbce1e6", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_plans/f8ec9a8f-587d-4984-9049-100f3a2b074f", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-11T13:20:32Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-1164", TestUtil.ToTestableString(obj[0].Name), true);
                ...
                Assert.AreEqual("ca2cf1af-d8a8-4592-9136-7f12dfbce1e6", TestUtil.ToTestableString(obj[0].ServiceGuid), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].Extra), true);
                Assert.AreEqual("4ae03f06-e48f-4f44-9232-9ae1a7a91c03", TestUtil.ToTestableString(obj[0].UniqueId), true);
                Assert.AreEqual("true", TestUtil.ToTestableString(obj[0].Public), true);
                Assert.AreEqual("true", TestUtil.ToTestableString(obj[0].Active), true);
                Assert.AreEqual("/v2/services/ce370e63-4022-4498-bfb5-3f3ad8d0a38f", TestUtil.ToTestableString(obj[0].ServiceUrl), true);
                Assert.AreEqual("/v2/service_plans/f8ec9a8f-587d-4984-9049-100f3a2b074f/service_instances", TestUtil.ToTestableString(obj[0].ServiceInstancesUrl), true);
