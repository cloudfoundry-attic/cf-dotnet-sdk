  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_bindings_url"": ""/v2/user_provided_service_instances/b56f97f4-c6c9-4bee-908b-a190fc2ae529/service_bindings""
                ...
                Assert.AreEqual("b56f97f4-c6c9-4bee-908b-a190fc2ae529", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/user_provided_service_instances/b56f97f4-c6c9-4bee-908b-a190fc2ae529", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-09T10:21:54Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-1890", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("aa6e98a3-7e52-4faa-bae3-252e8a6f58e9", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("user_provided_service_instance", TestUtil.ToTestableString(obj[0].Type), true);
                Assert.AreEqual("https://foo.com/url-75", TestUtil.ToTestableString(obj[0].SyslogDrainUrl), true);
                Assert.AreEqual("/v2/spaces/aa6e98a3-7e52-4faa-bae3-252e8a6f58e9", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/user_provided_service_instances/b56f97f4-c6c9-4bee-908b-a190fc2ae529/service_bindings", TestUtil.ToTestableString(obj[0].ServiceBindingsUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instance_url"": ""/v2/user_provided_service_instances/5461f6e5-27d4-4bf8-9e6f-53a84f25a865""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("657837eb-747a-4d65-a810-2dc14c72147e", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_bindings/657837eb-747a-4d65-a810-2dc14c72147e", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-02-09T10:21:54Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("cf179aa6-74c8-4795-9b35-b2c4db7a5e6e", TestUtil.ToTestableString(obj[0].AppGuid), true);
                Assert.AreEqual("5461f6e5-27d4-4bf8-9e6f-53a84f25a865", TestUtil.ToTestableString(obj[0].ServiceInstanceGuid), true);
                ...
                Assert.AreEqual("/v2/apps/cf179aa6-74c8-4795-9b35-b2c4db7a5e6e", TestUtil.ToTestableString(obj[0].AppUrl), true);
                Assert.AreEqual("/v2/user_provided_service_instances/5461f6e5-27d4-4bf8-9e6f-53a84f25a865", TestUtil.ToTestableString(obj[0].ServiceInstanceUrl), true);
