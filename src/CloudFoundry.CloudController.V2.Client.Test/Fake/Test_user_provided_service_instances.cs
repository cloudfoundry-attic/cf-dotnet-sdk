  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""routes_url"": ""/v2/user_provided_service_instances/dba71d62-fa23-4043-8729-bfb9fea6ccfb/routes""
                ...
                Assert.AreEqual("48c2b1db-bda5-4b10-b9e5-3de89aa57c6c", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/user_provided_service_instances/dba71d62-fa23-4043-8729-bfb9fea6ccfb", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2017-01-04T15:58:36Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("2017-01-04T15:58:36Z", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-143", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("48c2b1db-bda5-4b10-b9e5-3de89aa57c6c", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("user_provided_service_instance", TestUtil.ToTestableString(obj[0].Type), true);
                Assert.AreEqual("https://foo.com/url-23", TestUtil.ToTestableString(obj[0].SyslogDrainUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].RouteServiceUrl), true);
                Assert.AreEqual("/v2/spaces/bc952d03-ec3e-48c5-8ebb-07db9e092a8d", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/user_provided_service_instances/dba71d62-fa23-4043-8729-bfb9fea6ccfb/service_bindings", TestUtil.ToTestableString(obj[0].ServiceBindingsUrl), true);
                Assert.AreEqual("/v2/user_provided_service_instances/dba71d62-fa23-4043-8729-bfb9fea6ccfb/routes", TestUtil.ToTestableString(obj[0].RoutesUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instance_url"": ""/v2/user_provided_service_instances/810e9acd-c125-4121-9c60-c1034fcf85ac""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("ff011b99-af12-4b5f-a249-785339f16418", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_bindings/c60aa299-2bb2-4646-b09c-23520040b7d6", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2017-01-04T15:58:36Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("2017-01-04T15:58:36Z", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("ff011b99-af12-4b5f-a249-785339f16418", TestUtil.ToTestableString(obj[0].AppGuid), true);
                Assert.AreEqual("ff011b99-af12-4b5f-a249-785339f16418", TestUtil.ToTestableString(obj[0].ServiceInstanceGuid), true);
                ...
                Assert.AreEqual("/v2/user_provided_service_instances/810e9acd-c125-4121-9c60-c1034fcf85ac", TestUtil.ToTestableString(obj[0].ServiceInstanceUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""route_mappings_url"": ""/v2/routes/fc131cea-3368-4e1c-a7f3-1949e6c7bf6f/route_mappings""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("7142c689-06f8-4892-9459-82c4fb0b2188", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/routes/fc131cea-3368-4e1c-a7f3-1949e6c7bf6f", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2017-01-04T15:58:36Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("2017-01-04T15:58:36Z", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("host-3", TestUtil.ToTestableString(obj[0].Host), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].Path), true);
                Assert.AreEqual("7142c689-06f8-4892-9459-82c4fb0b2188", TestUtil.ToTestableString(obj[0].DomainGuid), true);
                Assert.AreEqual("7142c689-06f8-4892-9459-82c4fb0b2188", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("7142c689-06f8-4892-9459-82c4fb0b2188", TestUtil.ToTestableString(obj[0].ServiceInstanceGuid), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].Port), true);
                Assert.AreEqual("/v2/private_domains/926b3fae-7686-4481-832a-99e1064e65b9", TestUtil.ToTestableString(obj[0].DomainUrl), true);
                Assert.AreEqual("/v2/spaces/54a7cb4b-4d2e-467e-8b13-70f3b694067f", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/user_provided_service_instances/cb9e5776-63ce-4917-8f38-7dea461627d1", TestUtil.ToTestableString(obj[0].ServiceInstanceUrl), true);
                Assert.AreEqual("/v2/routes/fc131cea-3368-4e1c-a7f3-1949e6c7bf6f/apps", TestUtil.ToTestableString(obj[0].AppsUrl), true);
                Assert.AreEqual("/v2/routes/fc131cea-3368-4e1c-a7f3-1949e6c7bf6f/route_mappings", TestUtil.ToTestableString(obj[0].RouteMappingsUrl), true);
