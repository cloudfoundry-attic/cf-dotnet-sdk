  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""apps_url"": ""/v2/routes/49b5e000-111b-44da-a90e-9ac154f75a6b/apps""
                ...
                Assert.AreEqual("b343b7ad-4002-46b0-bf33-3a0bac3e8edb", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/routes/49b5e000-111b-44da-a90e-9ac154f75a6b", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-03-21T10:59:17Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                ...
                Assert.AreEqual("b343b7ad-4002-46b0-bf33-3a0bac3e8edb", TestUtil.ToTestableString(obj[0].DomainGuid), true);
                Assert.AreEqual("b343b7ad-4002-46b0-bf33-3a0bac3e8edb", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("b343b7ad-4002-46b0-bf33-3a0bac3e8edb", TestUtil.ToTestableString(obj[0].ServiceInstanceGuid), true);
                Assert.AreEqual("0", TestUtil.ToTestableString(obj[0].Port), true);
                Assert.AreEqual("/v2/domains/3a9e88e2-ef59-494a-9dc2-0d2a2dff8b93", TestUtil.ToTestableString(obj[0].DomainUrl), true);
                Assert.AreEqual("/v2/spaces/4a24965c-cc43-48ef-98af-d9d892dcedfb", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/service_instances/0e7a3a8b-6918-4db6-b19f-9604f1a13d2a", TestUtil.ToTestableString(obj[0].ServiceInstanceUrl), true);
                Assert.AreEqual("/v2/routes/49b5e000-111b-44da-a90e-9ac154f75a6b/apps", TestUtil.ToTestableString(obj[0].AppsUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""route_mappings_url"": ""/v2/apps/646eaf1c-96c8-48b4-abc0-0e7cc759aa85/route_mappings""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("88e62d85-893c-4b47-ac3d-79c371d4d66f", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/apps/646eaf1c-96c8-48b4-abc0-0e7cc759aa85", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-03-21T10:59:17Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("2016-03-21T10:59:17Z", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-67", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("false", TestUtil.ToTestableString(obj[0].Production), true);
                Assert.AreEqual("88e62d85-893c-4b47-ac3d-79c371d4d66f", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("88e62d85-893c-4b47-ac3d-79c371d4d66f", TestUtil.ToTestableString(obj[0].StackGuid), true);
                ...
                Assert.AreEqual("ef659271-d13f-467d-baa4-9905d60700ae", TestUtil.ToTestableString(obj[0].Version), true);
                ...
                Assert.AreEqual("2016-03-21T10:59:17Z", TestUtil.ToTestableString(obj[0].PackageUpdatedAt), true);
                ...
                Assert.AreEqual("/v2/spaces/647160b7-c5ae-4684-b3fe-b256052c37e0", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/stacks/96588c97-d5a7-4604-a6d8-5a885fe43efa", TestUtil.ToTestableString(obj[0].StackUrl), true);
                Assert.AreEqual("/v2/apps/646eaf1c-96c8-48b4-abc0-0e7cc759aa85/events", TestUtil.ToTestableString(obj[0].EventsUrl), true);
                Assert.AreEqual("/v2/apps/646eaf1c-96c8-48b4-abc0-0e7cc759aa85/service_bindings", TestUtil.ToTestableString(obj[0].ServiceBindingsUrl), true);
                Assert.AreEqual("/v2/apps/646eaf1c-96c8-48b4-abc0-0e7cc759aa85/routes", TestUtil.ToTestableString(obj[0].RoutesUrl), true);
                Assert.AreEqual("/v2/apps/646eaf1c-96c8-48b4-abc0-0e7cc759aa85/route_mappings", TestUtil.ToTestableString(obj[0].RouteMappingsUrl), true);
