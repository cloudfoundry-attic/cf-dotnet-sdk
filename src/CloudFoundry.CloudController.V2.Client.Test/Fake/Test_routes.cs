  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""route_mappings_url"": ""/v2/routes/c6d12dc4-cde7-4570-803c-c5d15569303e/route_mappings""
                ...
                Assert.AreEqual("dbd27f54-7a38-4994-bac4-d2cb65174752", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/routes/c6d12dc4-cde7-4570-803c-c5d15569303e", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                ...
                Assert.AreEqual("dbd27f54-7a38-4994-bac4-d2cb65174752", TestUtil.ToTestableString(obj[0].DomainGuid), true);
                Assert.AreEqual("dbd27f54-7a38-4994-bac4-d2cb65174752", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("dbd27f54-7a38-4994-bac4-d2cb65174752", TestUtil.ToTestableString(obj[0].ServiceInstanceGuid), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].Port), true);
                Assert.AreEqual("/v2/shared_domains/6d272331-5bb0-4b6b-828d-5f9ff32ab1f0", TestUtil.ToTestableString(obj[0].DomainUrl), true);
                Assert.AreEqual("/v2/spaces/18a9f6fa-7dc5-4fff-8986-45d9ca32c515", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/service_instances/ca56f507-dea3-4e4f-82a7-d144ea0f4ebe", TestUtil.ToTestableString(obj[0].ServiceInstanceUrl), true);
                Assert.AreEqual("/v2/routes/c6d12dc4-cde7-4570-803c-c5d15569303e/apps", TestUtil.ToTestableString(obj[0].AppsUrl), true);
                Assert.AreEqual("/v2/routes/c6d12dc4-cde7-4570-803c-c5d15569303e/route_mappings", TestUtil.ToTestableString(obj[0].RouteMappingsUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""route_mappings_url"": ""/v2/apps/3cb6ac3d-4c08-45aa-9c6a-0cd3b119b2a5/route_mappings""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("a75232b3-c15a-4ada-8a59-89e3b2735b57", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/apps/3cb6ac3d-4c08-45aa-9c6a-0cd3b119b2a5", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                ...
                Assert.AreEqual("name-117", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("false", TestUtil.ToTestableString(obj[0].Production), true);
                Assert.AreEqual("a75232b3-c15a-4ada-8a59-89e3b2735b57", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("a75232b3-c15a-4ada-8a59-89e3b2735b57", TestUtil.ToTestableString(obj[0].StackGuid), true);
                ...
                Assert.AreEqual("9bad7f55-06e8-4c65-8d69-ffec18147238", TestUtil.ToTestableString(obj[0].Version), true);
                ...
                Assert.AreEqual("2016-07-27T14:02:30Z", TestUtil.ToTestableString(obj[0].PackageUpdatedAt), true);
                ...
                Assert.AreEqual("/v2/spaces/60ac11d2-b5e4-4d50-8313-fc477a977fe6", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/stacks/e96007e9-45ce-47ef-84e3-4d1191a6040b", TestUtil.ToTestableString(obj[0].StackUrl), true);
                Assert.AreEqual("/v2/apps/3cb6ac3d-4c08-45aa-9c6a-0cd3b119b2a5/routes", TestUtil.ToTestableString(obj[0].RoutesUrl), true);
                Assert.AreEqual("/v2/apps/3cb6ac3d-4c08-45aa-9c6a-0cd3b119b2a5/events", TestUtil.ToTestableString(obj[0].EventsUrl), true);
                Assert.AreEqual("/v2/apps/3cb6ac3d-4c08-45aa-9c6a-0cd3b119b2a5/service_bindings", TestUtil.ToTestableString(obj[0].ServiceBindingsUrl), true);
                Assert.AreEqual("/v2/apps/3cb6ac3d-4c08-45aa-9c6a-0cd3b119b2a5/route_mappings", TestUtil.ToTestableString(obj[0].RouteMappingsUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""route_url"": ""/v2/routes/f1e33317-29bf-411f-8ba1-fb50865ebef9""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("18e407c2-1a58-456e-8fb0-de7e3a666cd0", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/route_mappings/61d3d23c-89ce-4def-9e02-052d9afbeee2", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-07-27T14:02:30Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].AppPort), true);
                Assert.AreEqual("18e407c2-1a58-456e-8fb0-de7e3a666cd0", TestUtil.ToTestableString(obj[0].AppGuid), true);
                Assert.AreEqual("18e407c2-1a58-456e-8fb0-de7e3a666cd0", TestUtil.ToTestableString(obj[0].RouteGuid), true);
                Assert.AreEqual("/v2/apps/a0331518-2e27-4ac2-8edb-f8c414fea6fd", TestUtil.ToTestableString(obj[0].AppUrl), true);
                Assert.AreEqual("/v2/routes/f1e33317-29bf-411f-8ba1-fb50865ebef9", TestUtil.ToTestableString(obj[0].RouteUrl), true);
