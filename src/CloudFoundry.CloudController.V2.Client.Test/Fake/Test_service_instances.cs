  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""route_mappings_url"": ""/v2/routes/d146460a-51fc-4b31-ae28-a38c40693bd8/route_mappings""
                ...
                Assert.AreEqual("1e59e53a-1cd0-4033-b12d-35df583d3e7e", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/routes/d146460a-51fc-4b31-ae28-a38c40693bd8", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-05-26T11:34:51Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                ...
                Assert.AreEqual("1e59e53a-1cd0-4033-b12d-35df583d3e7e", TestUtil.ToTestableString(obj[0].DomainGuid), true);
                Assert.AreEqual("1e59e53a-1cd0-4033-b12d-35df583d3e7e", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                Assert.AreEqual("1e59e53a-1cd0-4033-b12d-35df583d3e7e", TestUtil.ToTestableString(obj[0].ServiceInstanceGuid), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].Port), true);
                Assert.AreEqual("/v2/domains/dc1ad22a-b527-4f7d-b8e3-0e8a2cf186a2", TestUtil.ToTestableString(obj[0].DomainUrl), true);
                Assert.AreEqual("/v2/spaces/1654977d-dea6-4bb4-8227-5ce5d67137e5", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/service_instances/dbaff0ca-3221-43d1-ad10-a28a9c1d7b85", TestUtil.ToTestableString(obj[0].ServiceInstanceUrl), true);
                Assert.AreEqual("/v2/routes/d146460a-51fc-4b31-ae28-a38c40693bd8/apps", TestUtil.ToTestableString(obj[0].AppsUrl), true);
                Assert.AreEqual("/v2/routes/d146460a-51fc-4b31-ae28-a38c40693bd8/route_mappings", TestUtil.ToTestableString(obj[0].RouteMappingsUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""routes_url"": ""/v2/service_instances/bef589cd-ccd7-421d-9463-79bcb6c2b636/routes""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("ce9e45a9-5fb5-4276-9c75-5b5aacfbd38d", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_instances/bef589cd-ccd7-421d-9463-79bcb6c2b636", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-05-26T11:34:50Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("name-2385", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("ce9e45a9-5fb5-4276-9c75-5b5aacfbd38d", TestUtil.ToTestableString(obj[0].ServicePlanGuid), true);
                Assert.AreEqual("ce9e45a9-5fb5-4276-9c75-5b5aacfbd38d", TestUtil.ToTestableString(obj[0].SpaceGuid), true);
                ...
                Assert.AreEqual("/v2/spaces/80eccff2-d30c-4b1d-9e1a-1f3befe26555", TestUtil.ToTestableString(obj[0].SpaceUrl), true);
                Assert.AreEqual("/v2/service_plans/d9ea8853-3f11-4952-a954-f5f3b0d3a167", TestUtil.ToTestableString(obj[0].ServicePlanUrl), true);
                Assert.AreEqual("/v2/service_instances/bef589cd-ccd7-421d-9463-79bcb6c2b636/service_bindings", TestUtil.ToTestableString(obj[0].ServiceBindingsUrl), true);
                Assert.AreEqual("/v2/service_instances/bef589cd-ccd7-421d-9463-79bcb6c2b636/service_keys", TestUtil.ToTestableString(obj[0].ServiceKeysUrl), true);
                Assert.AreEqual("/v2/service_instances/bef589cd-ccd7-421d-9463-79bcb6c2b636/routes", TestUtil.ToTestableString(obj[0].RoutesUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instance_url"": ""/v2/service_instances/c995cc2a-4115-42ad-b94c-04fd84792184""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("af966807-f4e0-4dec-a709-d72469decfce", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_keys/5b038aee-c6b5-4a7e-9d13-5c0bf534514b", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-05-26T11:34:51Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("a-service-key", TestUtil.ToTestableString(obj[0].Name), true);
                Assert.AreEqual("af966807-f4e0-4dec-a709-d72469decfce", TestUtil.ToTestableString(obj[0].ServiceInstanceGuid), true);
                Assert.AreEqual("/v2/service_instances/c995cc2a-4115-42ad-b94c-04fd84792184", TestUtil.ToTestableString(obj[0].ServiceInstanceUrl), true);
  ...
  ""resources"": [
    {
      ...
      ""entity"": {
        ...
        ""service_instance_url"": ""/v2/service_instances/d433d00b-9aaa-458f-8bb3-60883e196d79""
                ...
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.PreviousUrl), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj.Properties.NextUrl), true);
                Assert.AreEqual("af6137da-47aa-4772-a071-8bc651ded0ba", TestUtil.ToTestableString(obj[0].EntityMetadata.Guid), true);
                Assert.AreEqual("/v2/service_bindings/40c82b11-4c5d-4d8e-a04a-863a41ba926c", TestUtil.ToTestableString(obj[0].EntityMetadata.Url), true);
                Assert.AreEqual("2016-05-26T11:34:51Z", TestUtil.ToTestableString(obj[0].EntityMetadata.CreatedAt), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].EntityMetadata.UpdatedAt), true);
                Assert.AreEqual("af6137da-47aa-4772-a071-8bc651ded0ba", TestUtil.ToTestableString(obj[0].AppGuid), true);
                Assert.AreEqual("af6137da-47aa-4772-a071-8bc651ded0ba", TestUtil.ToTestableString(obj[0].ServiceInstanceGuid), true);
                Assert.AreEqual("", TestUtil.ToTestableString(obj[0].GatewayData), true);
                ...
                Assert.AreEqual("/v2/apps/feeb2c1b-7536-4bd1-9305-0f30cc6a046d", TestUtil.ToTestableString(obj[0].AppUrl), true);
                Assert.AreEqual("/v2/service_instances/d433d00b-9aaa-458f-8bb3-60883e196d79", TestUtil.ToTestableString(obj[0].ServiceInstanceUrl), true);
