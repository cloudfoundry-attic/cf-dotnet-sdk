...
namespace cf_net_sdk
{
    public class CloudfoundryClient
    {
        ...
        public CloudfoundryClient(Url cloudTarget, CancellationToken cancellationToken, IServiceLocator serviceLocator)
        {
        ...
        public CloudfoundryClient(Url cloudTarget, CancellationToken cancellationToken) : this(cloudTarget, cancellationToken, new ServiceLocator()) { }                
