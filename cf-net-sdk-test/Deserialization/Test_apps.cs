...
namespace cf_net_sdk_test.Deserialization
{
  ...
  ""name"": ""new_name""
            ...
            UpdateAppRequest obj = Util.DeserializeJson<UpdateAppRequest>(json);
  ...
  ""environment_json"": {
    ...
    ""DIEGO_RUN_BETA"": ""true""
            ...
            CreateDockerAppExperimentalRequest obj = Util.DeserializeJson<CreateDockerAppExperimentalRequest>(json);
  ...
  ""space_guid"": ""cfa396a7-76dc-491c-8eab-d922227d495b""
            ...
            CreateAppRequest obj = Util.DeserializeJson<CreateAppRequest>(json);
  ...
  ""entity"": {
    ...
    ""routes_url"": ""/v2/apps/30c47909-d693-4c6b-8195-d9afb7c1ea93/routes""
        ...
        public void TestCopyAppBitsForAppExperimentalRequest()
        {
            ...
            CopyAppBitsForAppExperimentalRequest obj = Util.DeserializeJson<CopyAppBitsForAppExperimentalRequest>(json);
        
            Assert.AreEqual("e8ecabe0-502c-4a26-8b25-482f9a084d65", TestUtil.ToTestableString(obj.SourceAppGuid), true);
        }
